...
STATIC_ROOT = os.path.join(env('DRUMSCORE_STATIC_DIR', default=BASE_DIR), 'files', 'static')

MEDIA_URL = 'files/'

MEDIA_ROOT = os.path.join(env('DRUMSCORE_MEDIA_DIR', default=BASE_DIR), 'files', 'media')
